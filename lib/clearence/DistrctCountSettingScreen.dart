...
class DistrictCountSettingPortal extends StatelessWidget {
   DistrictCountSettingPortal({Key? key}) : super(key: key);
                          ...
                          InkWell(
                            onTap: ()  async {
                              ...
                              if(form!.validate() ) {
                                ...
                                mainProvider.clearDistrictCount();
                              }
                            ...
                            CircularProgressIndicator(color: myDarkGreen,):Container(
                              ...
                              child:const Center(
                                child: Text(
                                  ...
                                  "Clear here to Clear District Data First",
               ...
               children: [
                 Column(
                   children: [
                     ...
                     InkWell(onTap: (){
                       MainProvider mainProvider = Provider.of<MainProvider>(context, listen: false);
                        mainProvider.districtWiseLoopppp();
                        finish(context);
