...
class CoordinatorUnitLevelScreen extends StatelessWidget {
  String district,state,assembly,from;
   CoordinatorUnitLevelScreen({Key? key,required this.district,required this.assembly,required this.state,required this.from}) : super(key: key);
        ...
        body: Column(
          children: [
            ...
            const Align(alignment: Alignment.center,
                child: Text('UNIT REPORT',style: TextStyle(
                  ...
                  return Padding(
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        onChanged: (value) {
                          mainProvider.search(value,'ASSEMBLY_LEVEL');
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    SizedBox(
                      width: width*0.55,
                      child: const Text("Unit", style: TextStyle(
                        color: Colors.black,
                        fontSize: 12,
                        fontFamily: 'Poppins',
              ...
              return Flexible(
                child: ListView.builder(
                  padding: EdgeInsets.only(left: 15,right: 15,top: 10),
                    ...
                    itemCount: value.unitList.length,
                    shrinkWrap: true,
                    itemBuilder: (BuildContext context, int index) {
                      var item = value.unitList[index];
                      List<masterCordinatorModel> stateWiseCountList =
                      value.unitCordinator(state,district,assembly,item);
                      return Padding(
